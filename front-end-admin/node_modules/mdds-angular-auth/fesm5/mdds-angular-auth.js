 ...
 */
/** @type {?} */
var AUTHTICATION_SERVER_ROOT_URI = new InjectionToken('AUTHTICATION_SERVER_ROOT_URI');
/** @type {?} */
var AUTHTICATION_LOGIN_PAGE_URI = new InjectionToken('AUTHTICATION_LOGIN_PAGE_URI');
/** @type {?} */
var AUTHTICATION_INTERFACES = new InjectionToken('AUTHTICATION_INTERFACES');
...
var AuthIconComponent = /** @class */ (function () {
    ...
    /** @nocollapse */
    AuthIconComponent.ctorParameters = function () { return [
        { type: Router },
        { type: AuthenticationService },
        { type: String, decorators: [{ type: Inject, args: [AUTHTICATION_LOGIN_PAGE_URI,] }] }
    ]; };
